...
# from binance_api import Trade as tradeClass
import winsound
...
def main():
    ...
    # trade = tradeClass(api_key=api_key, api_secret=api_secret, testnet=False)
    # """ Borsadan hesap bakiyeleri getirilir """
    # account = trade.get_account()

    # res = trade.order_market_sell(symbol='FTMUSDT', quoteOrderQty=10)

...
def control_buy_signal(symbol=None, opens=None, highs=None,
    ...
    """
    KURAL:
    - Mevcut mum ve önceki 2 mum YEŞİL olacak
    - Mevcut fiyat MA altı olacak
    """
...
#    if (currCandleColor == cons.CANDLE_RED) or (prev1CandleColor == cons.CANDLE_RED) or (prev2CandleColor == cons.CANDLE_RED):
            ...
            if currMA > currLSMA:
                ...
                if currClose < currMA:
                    if currClose > prevClose:
                        ...
                        glbExplanation = f"CurPrice: {currClose} prevClose: {prevClose} MA cur,prev: {currMA}, {prev1MA} LSMA cur, prev: {currLSMA}, {prev1LSMA}"
                        return True
...
""" Mevcut mum ve önceki 2 mum YEŞİL ve mecvut fiyat MA nın altında """
def main():
